function Problem = softmax_regression_origin(x_train, y_train, x_test, y_test, lambda, num_class, regularization)
...
% Modified by H.Kasai on Oct. 25, 2016
    ...
    function f = cost(w)
        ...
        % calculate cost
        f = -logprob + regularization.cost(w);
